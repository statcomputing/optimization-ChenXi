...
##(e)
<font size = 3>According to the computation above we find some special properties of these methods:  

Newton Method: the speed of convergence of this method is the fastest while the stability is the worst.  
Fisher Method: The stability of fisher method is good while the speed of convergence is as satisfied as its stability.  
Fixed-point Method: the speed of convergence and stability of this method depend on $\alpha$. We find that the larger the $\alpha$is, the faster the speed of convergence will be and the worse the stability is.</font>
...
<font size = 3>So $K=820.5349872,~r=0.1926176, ~\sigma=0.6441323$.  
The variance of $K,~r,~\sigma^2$ are $6.248530*10^{4},~3.974068*10^{-3},~2.074532*10^{-2}$</font>